...
/*
- [x] collectNearbyReferences,
- [x] isCitation,
test: {
  - [x] adjacentNonWhitespaceNode,
  - [x] collectAdjacentReferenceNodes,
  - [x] collectNearbyReferenceNodes,
  - [x] isWhitespaceTextNode,
  - [x] closestReferenceClassElement,
  - [x] collectRefText,
  - [x] getFirstChildAnchor,
  - [x] getRefTextContainer,
  - [ ] hasCitationLink,
  - [ ] NearbyReferences,
  - [ ] ReferenceItem,
